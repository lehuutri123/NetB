	 ...
	 implements org.netbeans.modules.j2ee.dd.api.ejb.Interceptor
{
	...
	static public final String AROUND_CONSTRUCT = "AroundConstruct";	// NOI18N
	...
	public Interceptor(int options)
	{
		...
		this.createProperty("around-construct", 	// NOI18N
			AROUND_CONSTRUCT, 
			Common.TYPE_0_N | Common.TYPE_BEAN | Common.TYPE_KEY, 
	...
	// This attribute is an array, possibly empty
	public void setAroundConstruct(int index, org.netbeans.modules.j2ee.dd.api.ejb.LifecycleCallback valueInterface) {
		LifecycleCallback value = (LifecycleCallback) valueInterface;
		this.setValue(AROUND_CONSTRUCT, index, value);
	}

	//
	public org.netbeans.modules.j2ee.dd.api.ejb.LifecycleCallback getAroundConstruct(int index) {
		return (LifecycleCallback)this.getValue(AROUND_CONSTRUCT, index);
	}

	// Return the number of properties
	public int sizeAroundConstruct() {
		return this.size(AROUND_CONSTRUCT);
	}

	// This attribute is an array, possibly empty
	public void setAroundConstruct(org.netbeans.modules.j2ee.dd.api.ejb.LifecycleCallback[] value) {
		this.setValue(AROUND_CONSTRUCT, value);
	}

	//
	public org.netbeans.modules.j2ee.dd.api.ejb.LifecycleCallback[] getAroundConstruct() {
		return (LifecycleCallback[])this.getValues(AROUND_CONSTRUCT);
	}

	// Add a new element returning its index in the list
	public int addAroundConstruct(org.netbeans.modules.j2ee.dd.api.ejb.LifecycleCallback valueInterface) {
		LifecycleCallback value = (LifecycleCallback) valueInterface;
		int positionOfNewItem = this.addValue(AROUND_CONSTRUCT, value);
		return positionOfNewItem;
	}
	...
	// Returns the index the element had in the list
	//
	public int removeAroundConstruct(org.netbeans.modules.j2ee.dd.api.ejb.LifecycleCallback valueInterface) {
		LifecycleCallback value = (LifecycleCallback) valueInterface;
		return this.removeValue(AROUND_CONSTRUCT, value);
	}
	...
	public void validate() throws org.netbeans.modules.schema2beans.ValidateException {
		...
		// Validating property aroundConstruct
		for (int _index = 0; _index < sizeAroundConstruct(); ++_index) {
			org.netbeans.modules.j2ee.dd.impl.ejb.model_4_0.LifecycleCallback element = (org.netbeans.modules.j2ee.dd.impl.ejb.model_4_0.LifecycleCallback) getAroundConstruct(_index);
			if (element != null) {
	...
	public void dump(StringBuffer str, String indent){
		...
		str.append(indent);
		str.append("AroundConstruct["+this.sizeAroundConstruct()+"]");	// NOI18N
		for(int i=0; i<this.sizeAroundConstruct(); i++)
		{
			str.append(indent+"\t");
			str.append("#"+i+":");
			n = (org.netbeans.modules.schema2beans.BaseBean) this.getAroundConstruct(i);
			if (n != null)
				n.dump(str, indent + "\t");	// NOI18N
			else
				str.append(indent+"\tnull");	// NOI18N
			this.dumpAttributes(AROUND_CONSTRUCT, i, str, indent);
		}
