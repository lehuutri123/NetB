...
public class ServiceRefType extends org.netbeans.modules.schema2beans.BaseBean
{
	...
	// Add a new element returning its index in the list
	public int addPortComponentRef(org.netbeans.modules.j2ee.dd.impl.application.model_8.PortComponentRefType value) {
	...
	// Returns the index the element had in the list
	//
	public int removePortComponentRef(org.netbeans.modules.j2ee.dd.impl.application.model_8.PortComponentRefType value) {
	...
	// Add a new element returning its index in the list
	public int addHandler(org.netbeans.modules.j2ee.dd.impl.application.model_8.HandlerType value) {
	...
	// Returns the index the element had in the list
	//
	public int removeHandler(org.netbeans.modules.j2ee.dd.impl.application.model_8.HandlerType value) {
	...
	// Add a new element returning its index in the list
	public int addInjectionTarget(org.netbeans.modules.j2ee.dd.impl.application.model_8.InjectionTargetType value) {
	...
	// Returns the index the element had in the list
	//
	public int removeInjectionTarget(org.netbeans.modules.j2ee.dd.impl.application.model_8.InjectionTargetType value) {
	...
	public void validate() throws org.netbeans.modules.schema2beans.ValidateException {
		...
		for (int _index = 0; _index < sizePortComponentRef(); ++_index) {
			org.netbeans.modules.j2ee.dd.impl.application.model_8.PortComponentRefType element = getPortComponentRef(_index);
			if (element != null) {
				element.validate();
			}
		}
		...
		for (int _index = 0; _index < sizeHandler(); ++_index) {
			org.netbeans.modules.j2ee.dd.impl.application.model_8.HandlerType element = getHandler(_index);
			if (element != null) {
				element.validate();
			}
		}
		...
		for (int _index = 0; _index < sizeInjectionTarget(); ++_index) {
			org.netbeans.modules.j2ee.dd.impl.application.model_8.InjectionTargetType element = getInjectionTarget(_index);
			if (element != null) {
				element.validate();
			}
		}
